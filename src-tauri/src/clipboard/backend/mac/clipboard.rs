...
//! Copy from https://github.com/linebender/druid/blob/master/druid-shell/src/backend/mac/clipboard.rs
...
use super::util;
use crate::clipboard::clipboard::{ClipboardFormat, FormatId};
